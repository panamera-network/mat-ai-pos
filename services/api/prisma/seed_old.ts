...
const outlets = [
  { 
    id: 'outlet-hq', 
    name: 'MAT.ai HQ', 
    address: 'No. 1, Jalan Teknologi, Kuala Lumpur', 
  ...
  { 
    id: 'outlet-pj', 
    name: 'MAT.ai PJ', 
    address: 'No. 2, Jalan Universiti, Petaling Jaya', 
...
// ==================== DEPARTMENTS ====================
const departments = [
  { id: 'dept-kitchen', name: 'Kitchen', isActive: true },
  { id: 'dept-service', name: 'Service', isActive: true },
  { id: 'dept-management', name: 'Management', isActive: true },
  { id: 'dept-security', name: 'Security', isActive: true },
];
...
const staffData = [
  { 
    ...
    isSuperAdmin: true,
    employmentType: EmploymentType.MONTHLY_SALARIED, 
    monthlySalary: 3500, 
    hourlyRate: null,
    departmentId: null,
    outletId: null,           // ← Super admin = semua outlet
  },
  { 
    name: 'Siti', 
    ...
    outletId: 'outlet-hq',      // ← Assign ke HQ
  },
  { name: 'Ali', email: 'ali@restaurant.com', password: 'password123', pin: '3456', phone: '+60 14-567 8901', role: Role.CASHIER, isSuperAdmin: false, employmentType: EmploymentType.HOURLY_PART_TIME, monthlySalary: null, hourlyRate: 8, departmentId: 'dept-service', outletId: 'outlet-hq' },
  { name: 'Muthu', email: 'muthu@restaurant.com', password: 'password123', pin: '4567', phone: '+60 15-678 9012', role: Role.CASHIER, isSuperAdmin: false, employmentType: EmploymentType.HOURLY_PART_TIME, monthlySalary: null, hourlyRate: 8, departmentId: 'dept-service', outletId: 'outlet-hq' },
  { name: 'Lisa', email: 'lisa@restaurant.com', password: 'password123', pin: '5678', phone: '+60 16-789 0123', role: Role.KITCHEN, isSuperAdmin: false, employmentType: EmploymentType.HOURLY_PART_TIME, monthlySalary: null, hourlyRate: 9, departmentId: 'dept-kitchen', outletId: 'outlet-hq' },
  { name: 'Raj', email: 'raj@restaurant.com', password: 'password123', pin: '6789', phone: '+60 17-890 1234', role: Role.KITCHEN, isSuperAdmin: false, employmentType: EmploymentType.HOURLY_PART_TIME, monthlySalary: null, hourlyRate: 9, departmentId: 'dept-kitchen', outletId: 'outlet-hq' },
  { name: 'Nina', email: 'nina@restaurant.com', password: 'password123', pin: '7890', phone: '+60 18-901 2345', role: Role.CASHIER, isSuperAdmin: false, employmentType: EmploymentType.HOURLY_PART_TIME, monthlySalary: null, hourlyRate: 8, departmentId: 'dept-service', outletId: 'outlet-hq' },
  { name: 'Kumar', email: 'kumar@restaurant.com', password: 'password123', pin: '8901', phone: '+60 19-012 3456', role: Role.KITCHEN, isSuperAdmin: false, employmentType: EmploymentType.HOURLY_PART_TIME, monthlySalary: null, hourlyRate: 9, departmentId: 'dept-kitchen', outletId: 'outlet-hq' },
  { name: 'Farah', email: 'farah@restaurant.com', password: 'password123', pin: '9012', phone: '+60 10-123 4567', role: Role.CASHIER, isSuperAdmin: false, employmentType: EmploymentType.HOURLY_PART_TIME, monthlySalary: null, hourlyRate: 8, departmentId: 'dept-service', outletId: 'outlet-hq' },
  { name: 'Hafiz', email: 'hafiz@restaurant.com', password: 'password123', pin: '0123', phone: '+60 11-234 5678', role: Role.KITCHEN, isSuperAdmin: false, employmentType: EmploymentType.HOURLY_PART_TIME, monthlySalary: null, hourlyRate: 9, departmentId: 'dept-kitchen', outletId: 'outlet-hq' },
];
...
console.log('✅ Staff seeded — Ahmad is SUPER_ADMIN');
