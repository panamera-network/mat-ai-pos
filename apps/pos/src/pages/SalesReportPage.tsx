...
import { ArrowLeft, Download, TrendingUp, Calendar, RefreshCw } from 'lucide-react';
    ...
    <div className="h-full flex flex-col bg-gray-50">
      ...
      <header className="bg-white border-b px-4 py-3 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <h1 className="font-bold text-gray-900">Sales Report</h1>
        </div>
        <div className="flex items-center gap-2">
          ...
          <button className="flex items-center gap-2 px-4 py-2 bg-white border rounded-xl text-sm font-medium text-gray-700 hover:bg-gray-50 shadow-sm">
